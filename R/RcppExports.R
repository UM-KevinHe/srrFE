...
checkMemoryUsage <- function() {
    invisible(.Call(`_srrFE_checkMemoryUsage`))
}

logis_fe_prov <- function(Y, Z, n_prov, gamma, beta, backtrack = 1L, max_iter = 10000L, bound = 10.0, tol = 1e-5, message = TRUE) {
...
logis_BIN_fe_prov <- function(Y, Z, n_prov, gamma, beta, parallel = 1L, threads = 1L, tol = 1e-8, max_iter = 10000L, bound = 10.0, message = TRUE, backtrack = FALSE, stop = "beta") {
    .Call(`_srrFE_logis_BIN_fe_prov`, Y, Z, n_prov, gamma, beta, parallel, threads, tol, max_iter, bound, message, backtrack, stop)
}
